...
App = {
  ...
  contracts: {},
  contract:{},
  account: "0x6f7842426c1727ef882F3D166C7BB2C3146Eb766", //Placeholder value, will automatically replaced with the rederer's eth address.
  ...
  initContract: function() {
    ...
    var contractAddress = "0xb6e31e86dd38ef92c0d0c2095659f8e982f1dcac";//contract address 
  ...
  render: async function() {
    ...
    // Retrieve department value from localStorage
    ...
    for (var j = 0; j < contestants.length; j++) {
      ...
      // Check if the fetchedParty matches the department
      if (fetchedParty === department) {
